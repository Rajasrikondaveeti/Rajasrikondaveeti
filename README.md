...
<!-- HERO BANNER — Replace the URL below with your actual banner image hosted on GitHub -->
<!-- To use: Upload github_hero_banner.png to your Rajasrikondaveeti/Rajasrikondaveeti repo, then update the src -->
<img src="./github_hero_banner.png" alt="Rajasri Kondaveeti — Machine Learning Engineer" width="100%" />
...
### 🤖 [Snapr — Multi-AI Agent Deal Discovery](https://github.com/Rajasrikondaveeti/snapr)
> Multi-agent system using **LLMs + RAG** for real-time deal scoring & discovery. Containerized with Docker, deployed on **Modal**.
...
### 📚 [Hierarchical RAG AI Tutor](https://github.com/Rajasrikondaveeti/hierarchical-rag-ai-tutor)
> Intelligent study assistant with **lecture-first retrieval**, quiz generation, and web fallback via SerpAPI. Built with **Qdrant + OpenAI**.
...
![PEFT](https://img.shields.io/badge/PEFT-9B59B6?style=flat-square)
![Modal](https://img.shields.io/badge/Modal-000?style=flat-square)
...
> Modality-aware **deep learning framework** for re-identifying medical images across X-Ray, MRI, and CT. Research-grade pipeline.
...
> Professional-grade task management board built with **Next.js 15**. AI-powered task prioritization via **Google Gemma 3 Flash**.
...
![Model Governance](https://img.shields.io/badge/Model_Governance-1ABC9C?style=for-the-badge)
...
[![Modal](https://img.shields.io/badge/Modal-000000?style=for-the-badge)](https://modal.com)
...
## 🔭 Currently Exploring
```text
🧠  Advanced LLM architectures     ████████████░░░░   Active
🤖  Multi-agent AI systems          ██████████░░░░░░   Active
🔗  RAG & vector search at scale    ████████████░░░░   Active
⚡  QLoRA & PEFT fine-tuning        ████████░░░░░░░░   Active
🏗️  MLOps & production ML systems  ██████████████░░   Proficient
☁️  Cloud-native AI deployment      ██████████████░░   Proficient
```
