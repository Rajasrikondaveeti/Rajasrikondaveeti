...
I'm obsessed with the intersection of **LLMs + real-world systems**.I'm deep in the world of **advanced AI** right now — experimenting with multi-agent architectures, pushing the limits of RAG, exploring fine-tuning strategies, and building tools that actually solve real problems. Every experiment gets shipped and documented here on GitHub.
